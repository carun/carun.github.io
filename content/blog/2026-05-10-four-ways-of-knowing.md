...
{{ svg(path="images/four_stages_of_knowing.svg") }}
...
1. honest recognition that no external arrangement delivers lasting peace.
1. staying basically balanced through honor and insult, delight and distress.
